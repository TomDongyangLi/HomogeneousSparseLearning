...
switch sysInfo.ode_order
    ...
    case 2
        ...
        xpath_train = zeros(d*2*N+N*flagxi,length(obsInfo.time_vec),obsInfo.M);
        dxpath_train = zeros(d*2*N+N*flagxi,length(obsInfo.time_vec),obsInfo.M);
        ...
        xpath_test = zeros(d*2*N+N*flagxi,length(test_time_vec),obsInfo.M);
        dxpath_test = zeros(d*2*N+N*flagxi,length(test_time_vec),obsInfo.M);
