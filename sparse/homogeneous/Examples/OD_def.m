...
sysInfo.phi            = {@(r)OD_influence(r, 1)};                                               % energy based interaction
...
sysInfo.T_f             = 5;                                                                      % final time the system will reach steady state
sysInfo.domain          = [0, 10];
sysInfo.type = 1;
...
% Observations
obsInfo.M               = 10;                                                                      % # trajectories with random initial conditions for learning interaction kernel
obsInfo.time_vec = 0:0.01:0.1;
